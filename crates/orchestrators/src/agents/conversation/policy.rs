...
pub const CLASSIFICATION_PROMPT: &str = include_str!("classification.md").trim_ascii_end();

pub const ANSWERABILITY_PROMPT: &str = include_str!("answerability.md").trim_ascii_end();
